...
export default function SmartAgentPage() {
  ...
  const [databases, setDatabases] = useState<DatabaseSource[]>([
    { id: 'pinecone', name: 'Vector Knowledge Base', icon: <Database size={20} />, enabled: true, color: '#10b981' },
    ...
    { id: 'web', name: 'Web Search', icon: <Globe size={20} />, enabled: true, color: '#f59e0b' },
